...
INSTALL_DIR="$PROJECT_DIR/vendor/SDL3/install-tests"

# Build in a fast filesystem (NTFS on WSL is slow)
BUILD_BASE="/tmp/sdl3-build-tests"
SOURCE_DIR="$BUILD_BASE/source"
BUILD_DIR="$BUILD_BASE/build"

echo "=== SDL3 Build Script (with tests) ==="
...
echo "=== SDL3 build (tests) complete ==="
